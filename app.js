...
function seed(){
  ...
  var COMP_INCLUI=['Arroz branco','Macaxeira','Vinagrete'];
  ...
  ESP.forEach(function(r){
    ...
    if(r[2]) variacoes.push({nome:'Completo',preco:r[2],inclui:COMP_INCLUI.slice(),feijao:true});
...
function cupomHTML(o,reimp){
  ...
  return '<div class="ticket"><h1>DM ESPETINHO</h1><div class="tk-c tk-strong">— DELIVERY —</div><div class="tk-c">CUPOM DE COZINHA</div>'+
